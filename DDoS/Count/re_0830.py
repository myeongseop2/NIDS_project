...
x_train = np.reshape(x_train, (732791, 1, 21))
x_test = np.reshape(x_test, (314054, 1, 21))
...
# 1. 저장할 폴더와 형식을 선택
folder_directory ="C:/Users/admin/Desktop/Jdata"
...
MODEL_DIR = 'C:/Users/admin/Desktop/Jdata1'             # 모델을 저장하는 폴더
if not os.path.exists(MODEL_DIR):  # 만일 위의 폴더가 존재하지 않으면
    os.mkdir(MODEL_DIR)            # 이 이름의 폴더를 만들어 줌
model = tf.keras.models.load_model('C:/Users/admin/Desktop/Jdata/13000-0.0004.h5')
model.summary()
modelpath="C:/Users/admin/Desktop/Jdata1/{epoch:02d}-{val_loss:.4f}.h5"
my_period =1000
checkpointer = ModelCheckpoint(filepath=modelpath, monitor='val_loss', verbose=1, period=my_period)
