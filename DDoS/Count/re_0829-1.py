...
# 1. 저장할 폴더와 형식을 선택
folder_directory ="C:/Users/admin/Desktop/data-2"
...
MODEL_DIR = 'C:/Users/admin/Desktop/data-1'             # 모델을 저장하는 폴더
if not os.path.exists(MODEL_DIR):  # 만일 위의 폴더가 존재하지 않으면
    os.mkdir(MODEL_DIR)            # 이 이름의 폴더를 만들어 줌
model = tf.keras.models.load_model('C:/Users/admin/Desktop/data-1/28000-0.0049.h5')
model.summary()
modelpath="C:/Users/admin/Desktop/data-2/{epoch:02d}-{val_loss:.4f}.h5"
my_period =1000
